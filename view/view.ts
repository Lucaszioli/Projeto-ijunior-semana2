...
export const promptnome = ('Nome do Produto:');
export const promptvalor = ('Valor do Produto:');
export const promptpeso = ('Peso do produto em Kg:');
export const promptqntd = ('Quantidade de itens produto:')

export const promptremover = ('Produto que vai ser removido:')
